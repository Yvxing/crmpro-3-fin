	...
	<script type="text/javascript">
           $(function(){
                // 获取客户方信息,下拉选择框
                 $.ajax({
					 type:'GET',
					 url:'${pageContext.request.contextPath}/project/showCus',
					 dataType:'json',
					 success:function(rs){
               ...
               $.ajax({
                   type:'GET',
                   url:'${pageContext.request.contextPath}/project/showEmp',
				   data:{"pFk":4},
                   dataType:'json',
                   success:function(rs){
                       $(rs).each(function(index,item){
...
<form name="form4" id="form4" action="${pageContext.request.contextPath}/project/savePro" method="POST">
