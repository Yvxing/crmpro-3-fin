...
<link rel="stylesheet" type="text/css" href="skin/css/main.css" />
	...
	<script type="text/javascript">
        ...
        $(function(){
            ...
            $.ajax({
                type:'GET',
                url:'${pageContext.request.contextPath}/usual/showMainPage',
                dataType:'json',
            ...
            $.ajax({
                ...
                success:function(resultData){
                    ...
                    $(resultData).each(function(index,item){
                        ...
                        tr += "<td><ul> <li> <span id='p'> <img src='${pageContext.request.contextPath}/images/"+i+".jpg' height='50px' width='50px'/> </span> <br><font>发布时间："+newdate.getFullYear()+"-"+newdate.getMonth()+1+"-"+newdate.getDate()+"</font><br>标题： <a href='${pageContext.request.contextPath}/usual/getForumAndReply?fid="+item.forumid+" 'class='notice-title'>"+item.forumtitle+"</a></li> </ul></td>";
                        if(index!=0 && i%3 ==0 ) {
                            var ttr = tr + "</tr>";
                            $("#ff").before(ttr);
                        }
