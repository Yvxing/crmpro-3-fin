...
<div>
    <form name="form2" action="${pageContext.request.contextPath}/usual/addEvaluate" id="form15" method="post">
        <input type="hidden" value="${sessionScope.forum.forumid}" name="forumFk">
        ...
        <table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center"
            ...
            <tr>
                ...
                <td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';"
                    ...
                    <span>发布人：${sessionScope.forum.employee.ename}</span><br>
                    <span>发布时间:<fmt:formatDate value="${sessionScope.forum.createtime}" pattern="yyyy-MM-dd HH :mm:ss"></fmt:formatDate>  </span><br>
                    <span>标题：${sessionScope.forum.forumtitle}</span><br>
                    <span>内容:${sessionScope.forum.forumcontent}</span>
                </td>
            </tr>
            <!-- 遍历我们的一级评论 -->
            <c:forEach items="${sessionScope.forum.evaluateList}" var="firsteval">
            <tr>
                <td align="right" bgcolor="#FAFAF1" height="22">
					<span>
                ...
                <td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';"
                    onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
                    <span>评论人：${firsteval.employee.ename}</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <span>评论时间：<fmt:formatDate value="${firsteval.evatime}" pattern="yyyy-MM-dd HH :mm:ss"></fmt:formatDate> </span><br>
                    <span>评论内容:${firsteval.evacontent}</span>
                    &nbsp;<span><a href="${pageContext.request.contextPath}/forum-resentment.jsp?evaidFk=${firsteval.evaid}&forumFk=${sessionScope.forum.forumid}">【回复】</a></span>
                </td>
            </tr>
                <c:if test="${!empty firsteval.evaluateList}">
                    ...
                    <tr>
                        ...
                        <td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';"
                            ...
                            <span>回复时间：<fmt:formatDate value="${child.evatime}" pattern="yyyy-MM-dd HH :mm:ss"></fmt:formatDate></span><br>
                            <span>回复内容:${child.evacontent}</span>
                            &nbsp;<span><a href="${pageContext.request.contextPath}/forum-resentment.jsp?evaidFk=${child.evaid}&forumFk=${sessionScope.forum.forumid}">【回复】</a></span>
