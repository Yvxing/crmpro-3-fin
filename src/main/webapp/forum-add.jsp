...
<div>
<form name="form2" action="${pageContext.request.contextPath}/usual/saveForumPost" id="form3">
...
<tr >
	...
	<td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<script id="editor" name="forumcontent" type="text/plain" style="width:1024px;height:500px;"></script></td>
</tr>
