...
<form name="form2" id="form6" action="${pageContext.request.contextPath}/attachment/addatt" method="post" enctype="multipart/form-data" >
...
<tr >
	...
	<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<select id="pro" name="proFk"><option value="" disabled selected hidden>选择项目</option></select>
	</td>
</tr>
<tr >
