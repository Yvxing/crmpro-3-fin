...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/skin/css/base.css">
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#daochu").click(function () {
                ...
                $.ajax({
                    type:'post',
                    url:'/project/daochu?ids='+ids,
                    dataType:'text',
                    success:function (data) {
                        if (data=="true") {
                            alert("find file in e://aa.xls")
                        }else{
    ...
    <script type="text/javascript">
        $(function(){
            $.ajax({
                type: 'GET',
                url: '${pageContext.request.contextPath}/function/showFunction',
                dataType: 'json',
                success: function (resultData) {
                    $(resultData).each(function (index, item) {
                          var tr ="<tr align='center' bgcolor=\"#FFFFFF\" onMouseMove=\"javascript:this.bgColor='#FCFDEE';\" onMouseOut=\"javascript:this.bgColor='#FFFFFF';\" height=\"22\" >\n" +
                              ...
                              "\t<td>"+item.id+"</td>\n" +
                              "\t<td align=\"center\"><a href=''><u>"+item.functionname+"</u></a></td>\n" +
                              "\t<td align=\"center\"><a href=''><u>"+item.module.modname+"</u></a></td>\n" +
                              "\t<td align=\"center\"><a href=''><u>"+item.module.analysis.title+"</u></a></td>\n" +
                              "\t<td align=\"center\"><a href=''><u>"+item.module.analysis.project.pname+"</u></a></td>\n"+
                              "\t<td>"+item.level+"</td>\n" +
                              "\t<td>2015-02-03</td>\n" +
                              "\t<td>2015-06-03</td>\n" +
