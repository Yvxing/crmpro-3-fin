...
<form name="form2" action="${pageContext.request.contextPath}/usual/addEvaluate" id="form23">
	<!--  回复的那个评价的id -->
    <input type="hidden" name="evaidFk" value="${param.evaidFk}">
	<!--  就是那个帖子的id -->
	<input type="hidden" name="forumFk" value="${param.forumFk}">
...
<tr >
	...
	<td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<script id="editor" name="evacontent" type="text/plain" style="width:1024px;height:500px;"></script></td>
</tr>
