            ...
            $.ajax({
                ...
                success:function(rs){
                    ...
                    $(rs).each(function(index,item){
                        ...
                        var tr ="<tr name='ajaxtr' align='center' bgcolor=\"#FFFFFF\" onMouseMove=\"javascript:this.bgColor='#FCFDEE';\" onMouseOut=\"javascript:this.bgColor='#FFFFFF';\" height=\"22\" >\n" +
                            "\t<td><input name=\"id\" type=\"checkbox\" id=\"id\" value=\""+item.task.id+"\" class=\"np\"></td>\n" +
                            "\t<td>"+item.task.id+"</td>\n" +
                            "\t<td>"+item.task.tasktitle+"</td>\n" +
                            "\t<td align=\"center\">"+item.employee.ename+"</td>\n" +
                            "\t<td align=\"center\">"+status+"</td>\n" +
                            "\t<td align=\"center\">"+item.task.level+"</td>\n" +
                            "\t<td>"+dateStr(item.task.starttime)+"</td>\n" +
                            "\t<td>"+dateStr(item.task.endtime)+"</td>\n" +
                            "\t<td><a href=\"/task-edit.jsp\">编辑</a> | <a href=\"/task-look.jsp\">查看详情</a></td>\n" +
                            "</tr>";
...
<td height="28" colspan="12">
	&nbsp;
	<a href="javascript:taskinfo(1)" class="coolbg">未完成的任务</a>
	<a href="javascript:taskinfo(2)" class="coolbg">已完成的任务</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<a href="javascript:taskinfo(0)" class="coolbg">未开始的任务</a>
