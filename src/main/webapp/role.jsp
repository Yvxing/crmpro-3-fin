...
<link rel="stylesheet" type="text/css" href="skin/css/base.css">
	...
	<script type="text/javascript">
                   ...
                   success: function (rs) {
                        $(rs).each(function(index,item){
                            ...
                            var tr = "<tr align='center' bgcolor=\"#FFFFFF\" onMouseMove=\"javascript:this.bgColor='#FCFDEE';\" onMouseOut=\"javascript:this.bgColor='#FFFFFF';\" height=\"22\" >\n" +
                                ...
                                "\t<td>"+newstatus+"</td>\n" +
                                "\t<td><a href='javascript:deleteInfo("+item.roleid+")'>删除</a> |<a href=\"role-edit.jsp?roleid="+item.roleid+"\">编辑</a> | <a href=\"role-look.jsp\">查看详情</a></td>\n" +
                                "</tr>";
                            $("#ttr").after(tr);
		   ...
		   function  deleteInfo(obj){
                var rs = confirm("确认删除当前角色么?");
                if(rs){
                     window.location.href="${pageContext.request.contextPath}/role/deleteRole?roleid="+obj;
				}
		   }
