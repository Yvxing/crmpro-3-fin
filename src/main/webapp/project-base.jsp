                  ...
                  success:function(rs){
                      $(rs).each(function(index,item){
                          ...
                          var tr ="<tr align='center' bgcolor=\"#FFFFFF\" onMouseMove=\"javascript:this.bgColor='#FCFDEE';\" onMouseOut=\"javascript:this.bgColor='#FFFFFF';\" height=\"22\" >\n" +
                              "\t<td><input name=\"id\" type=\"checkbox\" id=\"id\" value=\""+item.project.pid+"\" class=\"np\"></td>\n" +
                              ...
                              "\t<td>进行中</td>\n" +
                              "\t<td><a href=\"/project/toupdate?pid="+item.project.pid+"\">编辑</a> | <a href=\"/project/detail?pid="+item.project.pid+"\">查看详情</a></td>\n" +
                              "</tr>";
...
<!--  搜索表单  -->
<form name='form3' action='/project/search' method='get'>
    ...
    <td background='skin/images/wbg.gif' align='center'>
      <table border='0' cellpadding='0' cellspacing='0'>
        <tr>
          ...
          <option  disabled selected hidden>选择类型...</option>
