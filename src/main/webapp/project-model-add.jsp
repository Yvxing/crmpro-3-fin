...
<head>
    ...
    <script type="application/javascript">
        $(function () {
            $.ajax({
                type: 'GET',
                url: '${pageContext.request.contextPath}/pro/showNoAnalysisPro?mark=2',
                dataType: 'json',
        ...
        function aa() {
          ...
          //ajax 局部刷新
           $.ajax({
                type: 'GET',
                url: '${pageContext.request.contextPath}/module/checkName',
                data: {"modname": $("#cname").val(), "analysisFk": $("#pro").val()},
                dataType: 'json',
                success: function (resultData) {
...
<form name="form2" id="form4" action="${pageContext.request.contextPath}/module/saveInfo" method="post">
    ...
    <table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center"
        ...
        <tr>
            ...
            <td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';"
                onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
                <input id="cname" name="modname"/></td>
        </tr>
        <tr>
